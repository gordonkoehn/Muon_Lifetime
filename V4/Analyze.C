...
void Analyze::Begin(TTree * /*tree*/)
{
   ...
   muonHist = new TH1D("decayTime", "Histogram of Muon Decay Times",10,4.5,18.25);
   muonHist->GetXaxis()->SetTitle("decay time [micro-sec]");
   muonHist->GetYaxis()->SetTitle("No. of events");
...
void Analyze::Terminate()
{
   ...
   // the results graphically or save the results to file.
	...
	TF1 myExpo("myExpo","expo + [2]");
	muonHist->Fit("myExpo");	

	auto c1 = new TCanvas("c1","c1",600,400);
	muonHist->SetMarkerStyle(kFullTriangleUp);
	muonHist->Draw();
	c1->SetGrid();
	c1 -> SaveAs("muonHist.png");
}
